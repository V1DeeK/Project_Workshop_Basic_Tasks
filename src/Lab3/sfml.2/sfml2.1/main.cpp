...
int main()
{
    ...
    while (window.isOpen())
    {
        ...
        // Если шарик достиг правого края окна (с учетом радиуса)
        if (x + ballRadius >= windowWidth)
        {
            ...
            // Отрицательная скорость означает движение влево
            velocityX = -velocityX;
        }
        // Проверяем столкновение с левой стенкой
        // Если шарик достиг левого края окна (с учетом радиуса)
        else if (x - ballRadius <= 0.0f)
        {
            ...
            x = ballRadius;
            // Меняем направление движения на противоположное (отталкивание)
            // Положительная скорость означает движение вправо
            velocityX = -velocityX;
        }
